...
class ModelTest():
    ...
    def grid_cs(self, n_configs):
        # TODO : remove sqrt for bigger config spaces
        n = int(round(np.sqrt(n_configs)))
    ...
    def test_grid(self, n_configs):
        ...
        # TODO : why n smaller than n_configs ?
    ...
    def test_smbo(self, n_iter, n_configs_init=8, n_configs_loop=256):
...
def main():
    ...
    svr_test(datasets, n_configs=64)
